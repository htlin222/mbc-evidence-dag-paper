...
\caption{Pilot $\to$ production $\to$ multi-tumor trajectory of EFDPR (left axis) and the pre-registered exact-binomial test $P$-value (right axis, $-\log_{10}$ scale). The pooled 49-node test rejects at $P = 0.023$ ($-\log_{10} P = 3.4$).}
